...
$('#AdharNo').change(function () {
    ...
    var url = "/ContractorMaster/ValidateAdharNo?AdharNo=" + AdharNo;
    $.ajax({
        cache: false,
        type: 'POST',
        url: url,
...
$('#PANCardNo').change(function () {
    ...
    var url = "/ContractorMaster/ValidatePANCardNo?PANCardNo=" + PANCardNo;
    $.ajax({
        cache: false,
        type: 'POST',
        url: url,
...
$('#Email').change(function () {
    var Email = $("#Email").val();
    var url = "/ContractorMaster/ValidateEmail?Email=" + Email;
    $.ajax({
        cache: false,
        type: 'POST',
        url: url,
...
$('#WhatsAppNo').change(function () {
    ...
    var url = "/ContractorMaster/ValidateWhatsAppNo?WhatsAppNo=" + WhatsAppNo;
    $.ajax({
        cache: false,
        type: 'POST',
        url: url,
...
$('#ContactNo').change(function () {
    ...
    var url = "/ContractorMaster/ValidateContactNo?ContactNo=" + ContactNo;
    $.ajax({
        cache: false,
        type: 'POST',
        url: url,
