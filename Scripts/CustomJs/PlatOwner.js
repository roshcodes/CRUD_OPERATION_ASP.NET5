...
$('#AdharNo').change(function () {
    ...
    var url = "/PlatOwner/ValidateAdharNo?AdharNo=" + AdharNo;
    $.ajax({
        cache: false,
        type: 'POST',
        url: url,
...
$('#PANCardNo').change(function () {
    ...
    var url = "/PlatOwner/ValidatePANCardNo?PANCardNo=" + PANCardNo;
    $.ajax({
        cache: false,
        type: 'POST',
        url: url,
...
$('#Email').change(function () {
    var Email = $("#Email").val();
    var url = "/PlatOwner/ValidateEmail?Email=" + Email;
    $.ajax({
        cache: false,
        type: 'POST',
        url: url,
...
$('#WhatsAppNo').change(function () {
    ...
    var url = "/PlatOwner/ValidateWhatsAppNo?WhatsAppNo=" + WhatsAppNo;
    $.ajax({
        cache: false,
        type: 'POST',
        url: url,
...
$('#AlternetContactNo').change(function () {
    ...
    var url = "/PlatOwner/ValidateAlternetContactNo?AlternetContactNo=" + AlternetContactNo;
    $.ajax({
        cache: false,
        type: 'POST',
        url: url,
...
$('#ContactNo').change(function () {
    ...
    var url = "/PlatOwner/ValidateContactNo?ContactNo=" + ContactNo;
    $.ajax({
        cache: false,
        type: 'POST',
        url: url,
