...
$('#AdharNo').change(function () {
    ...
    var url = "/SupplierMaster/ValidateAdharNo?AdharNo=" + AdharNo;
    $.ajax({
        cache: false,
        type: 'POST',
        url: url,
...
$('#PANCardNo').change(function () {
    ...
    var url = "/SupplierMaster/ValidatePANCardNo?PANCardNo=" + PANCardNo;
    $.ajax({
        cache: false,
        type: 'POST',
        url: url,
...
$('#Email').change(function () {
    var Email = $("#Email").val();
    var url = "/SupplierMaster/ValidateEmail?Email=" + Email;
    $.ajax({
        cache: false,
        type: 'POST',
        url: url,
...
$('#WhatsAppNo').change(function () {
    ...
    var url = "/SupplierMaster/ValidateWhatsAppNo?WhatsAppNo=" + WhatsAppNo;
    $.ajax({
        cache: false,
        type: 'POST',
        url: url,
...
$('#ContactNo').change(function () {
    ...
    var url = "/SupplierMaster/ValidateContactNo?ContactNo=" + ContactNo;
    $.ajax({
        cache: false,
        type: 'POST',
        url: url,
