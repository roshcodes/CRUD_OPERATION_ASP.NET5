...
$('#AdharNo').change(function () {
    ...
    var url = "/ReferencePerson/ValidateAdharNo?AdharNo=" + AdharNo;
    $.ajax({
        cache: false,
        type: 'POST',
        url: url,
...
$('#PANCardNo').change(function () {
    ...
    var url = "/ReferencePerson/ValidatePANCardNo?PANCardNo=" + PANCardNo;
    $.ajax({
        cache: false,
        type: 'POST',
        url: url,
...
$('#Email').change(function () {
    var Email = $("#Email").val();
    var url = "/ReferencePerson/ValidateEmail?Email=" + Email;
    $.ajax({
        cache: false,
        type: 'POST',
        url: url,
...
$('#WhatsAppNo').change(function () {
    ...
    var url = "/ReferencePerson/ValidateWhatsAppNo?WhatsAppNo=" + WhatsAppNo;
    $.ajax({
        cache: false,
        type: 'POST',
        url: url,
...
$('#AlternetContactNo').change(function () {
    ...
    var url = "/ReferencePerson/ValidateAlternetContactNo?AlternetContactNo=" + AlternetContactNo;
    $.ajax({
        cache: false,
        type: 'POST',
        url: url,
...
$('#ContactNo').change(function () {
    ...
    var url = "/ReferencePerson/ValidateContactNo?ContactNo=" + ContactNo;
    $.ajax({
        cache: false,
        type: 'POST',
        url: url,
